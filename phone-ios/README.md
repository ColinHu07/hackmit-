...
- Movement is scaled: 1 real meter equals 0.2 world units. The existing board spans -3 to +3 in X/Z. The view automatically rebases the pet to the center at its edge, preserving heading and the latest GPS anchor so subsequent steps keep working. This is a north-aligned miniature world, not AR world anchoring or measured placement of other pets. Nearby visitors still use the explicitly illustrative arrangement.

...
Play together takes nine seconds. `PlayChoreography` gives two to four pets separate places around a grounded toy, a shared lap, a bow and forepaw greeting, and a smooth return to their resting places. A deterministic contact solver keeps the displayed pets 1.9 scene units apart, including when their shared destinations coincide or a spectator approaches. This is presentation spacing, not a physical-world collision claim or a change to GPS/player coordinates. Actual displayed travel drives footsteps and facing; shared action time keeps the group synchronized. The follow camera retains its walking heading. Reduced motion keeps the same safe resting places without the lap.

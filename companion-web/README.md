...
```sh
HOST=0.0.0.0 npm run play:server
```
...
5. **Wave**, then **Play together** once your pets are close. Both screens show the same animation and shared quest completion. **Treat** and **Jump** are also synchronized.
